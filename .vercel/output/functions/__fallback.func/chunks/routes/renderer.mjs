...
import { j as joinRelativeURL, a as useRuntimeConfig, b as getResponseStatusText, c as getResponseStatus, d as decodePath, e as defineRenderHandler, f as getQuery, h as createError, i as getRouteRules, k as joinURL, u as useNitroApp } from '../_/nitro.mjs';
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"apple-mobile-web-app-capable","content":"yes"},{"name":"apple-mobile-web-app-status-bar-style","content":"black-translucent"}],"link":[{"rel":"apple-touch-icon","href":"/icons/icon-192x192.png"}],"style":[],"script":[],"noscript":[]};
